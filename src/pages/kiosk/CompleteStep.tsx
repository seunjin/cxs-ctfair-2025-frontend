  ...
  return (
    <div className="flex h-full flex-col py-[130px] px-20">
      <section className="pb-[63px]">
        <div className="self-stretch h-28 text-center justify-start text-[#0033FF] text-8xl font-extrabold leading-[110px] [text-shadow:_0px_0px_15px_rgb(208_82_153_/_1.00)]">
          FINISH !
        </div>
        <div className="text-center justify-start">
          <span className="text-white text-5xl font-semibold leading-[75px]">
            휴대폰번호를 입력하시면 <br />
          </span>
          <span className="text-yellow-300 text-5xl font-semibold leading-[75px]">
            생성 완료 후
          </span>
          <span className="text-white text-5xl font-semibold leading-[75px]">
            {' '}
      ...
      <section>
        <div className="text-center justify-start">
          <span className="text-white text-5xl font-semibold font-['Pretendard'] leading-[75px] [text-shadow:_0px_2px_9px_rgb(0_0_0_/_0.25)]">
            AI가 만든 당신의 런웨이 영상은
            <br />약{' '}
          </span>
          <span className="text-yellow-300 text-5xl font-extrabold font-['Pretendard'] leading-[75px] [text-shadow:_0px_2px_9px_rgb(0_0_0_/_0.25)]">
            5분
          </span>
          <span className="text-white text-5xl font-semibold font-['Pretendard'] leading-[75px] [text-shadow:_0px_2px_9px_rgb(0_0_0_/_0.25)]">
            {' '}
